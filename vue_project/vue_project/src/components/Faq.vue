...
.nav-list-faq li a:hover {
    color: rgb(0, 142, 24);
}

.nav-list-faq li:last-of-type a {
    display: flex;
    align-items: center;
    color: white;
...
.nav-list-faq li:last-of-type a:hover {
    background-color: rgb(111, 29, 29);
}

.nav-list-faq li:last-of-type a svg {
    width: 20px;
    margin-right: 5px;
}
